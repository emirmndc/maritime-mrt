...
export const voyages: VoyageRecord[] = [
  ...
  {
    id: "rostov-02",
    vessel: "MV Marmara Arc",
    owner: "Blue Sea Shipping",
    charterer: "Anatolia Grains",
    broker: "SO Shipping",
    cargo: "6,200 MT barley",
    route: "Azov → Izmir",
    freight: "USD 223,200",
    paymentTerm: "2 banking days after signed B/L copy",
    status: "Awaiting NOR event",
    nextDeadline: "Agent nomination overdue",
    riskLevel: "High",
    summary: [
      ["Owner", "Blue Sea Shipping"],
      ["Charterer", "Anatolia Grains"],
      ...
      ["Route", "Azov → Izmir"],
      ["Status", "Awaiting NOR event"],
      ["Next deadline", "Agent nomination overdue"],
      ["Risk", "High"],
    ],
    ownerTasks: [],
    chartererTasks: [],
