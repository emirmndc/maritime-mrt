...
export function SettlementWorkflowPage() {
  ...
  const handleSplitAndNeutralize = () => {
    ...
    setTimeline((current) => [
      {
        id: `evt-${eventIdBase}-1`,
        action: "Tartismasiz kisim serbest birakildi",
        timestamp: createdAt,
        actor: "Settlement workflow",
      },
      {
        id: `evt-${eventIdBase}-2`,
        action: "Tartismali kisim vault icine alindi",
        timestamp: createdAt,
        actor: "Settlement workflow",
      },
      {
        id: `evt-${eventIdBase}-3`,
        action: "Karsi taraf yaniti bekleniyor",
        timestamp: createdAt,
        actor: "Settlement workflow",
      },
      ...current,
        ...
        <Surface>
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-black/10 p-5">
            ...
            <div className="mt-3 max-w-3xl text-sm leading-7 text-white/68">
              ...
              a narrower move: release the undisputed portion and isolate only the disputed portion
              in a neutral vault.
            </div>
          </div>
